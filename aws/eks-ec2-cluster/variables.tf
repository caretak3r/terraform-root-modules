...
variable "vpc_id" {
  type        = string
  description = "The VPC id used for the EKS cluster or workers deployment"
}

variable "public_subnet_ids" {
  type        = list(string)
  description = "AWS public subnets ids a list of strings"
}

variable "private_subnet_ids" {
  type        = list(string)
  description = "AWS private subnets ids a list of strings"
}
