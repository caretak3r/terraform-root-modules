...
variable "region" {
  type        = string
  description = "AWS region to deploy the cdn into"
  default     = "us-east-1"
}
...
variable "bucket_acl" {
  type = string
  default = "private"
  description = "ACL for S3 bucket, public or private"
}
...
variable "versioning_enabled" {
  type        = bool
  default     = false
  description = "Enable or disable versioning on bucket and objects"
}
...
variable "abort_incomplete_multipart_upload_days" {
  type        = string
  default     = 7
  description = "Number of days to abort incomplete uploads"
}

variable "expired_object_delete_marker_enabled" {
  type        = bool
  default     = false
  description = "Enable or disable expired objects delete markers when versioning is enabled"
}

variable "access_blocks" {
  type        = map(bool)
  description = "Map of public access blocks for S3 bucket"
  default = {}
}

variable "s3_origin_id" {
  type = string
  description = "unique origin id to use for distribution"
  default =  "S3origin"
}